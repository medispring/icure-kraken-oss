...
import org.taktik.icure.services.external.rest.v1.mapper.ReplicatorDocumentMapper
...
class ReplicationController(
	...
	private val replicatorDocumentMapper: ReplicatorDocumentMapper,
) {
	@Operation(summary = "Get replication documents", description = "Get all replication infos and states")
	@GetMapping("/docs")
	fun getReplicationDocs() = mono {
		replicationLogic.listReplicationDocs().map { replicatorDocumentMapper.map(it) }
	}
