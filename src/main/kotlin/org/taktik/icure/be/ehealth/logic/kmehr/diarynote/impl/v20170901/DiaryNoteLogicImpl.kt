...
class DiaryNoteLogicImpl(val contactLogic: ContactLogic, @Qualifier("dairyNoteExport") val diaryNoteExport: DiaryNoteExport, @Qualifier("diaryNoteImport") val diaryNoteImport: DiaryNoteImport) : DiaryNoteLogic {
	override fun createDiaryNote(pat: Patient, enckeys: List<String>, sender: HealthcareParty, recipient: HealthcareParty, language: String, note: String?, tags: List<String>, contexts: List<String>, isPsy: Boolean, documentId: String?, attachmentId: String?, decryptor: AsyncDecrypt?) = diaryNoteExport.createDiaryNote(pat, enckeys, sender, recipient, language, note, tags, contexts, isPsy, documentId, attachmentId, decryptor)
